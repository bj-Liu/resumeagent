...
class Webserver:
    def __init__(self, save_file="saves/", preview_mode=False):
        ...
        if web_type == "chrome":
            ...
            driver_path = "/home/xxx/.wdm/drivers/geckodriver/linux64/v0.35.0/geckodriver"
...
if __name__ == "__main__":
    webserver = Webserver()
    webserver.get_screenshot("https://xxx.github.io/","example1.png",is_local = False)
    webserver.stop()